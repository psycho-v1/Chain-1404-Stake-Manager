...
(() => {
  ...
  function buildReport(pack, extra) {
    ...
    lines.push(line("  Mining pool locked", pool));
    ...
    if (com && com.ok && comPos > 0n) {
      ...
      lines.push("believes they staked, the usual causes are: wrong pool address locked; the");
    ...
    lines.push("  3. Lock the mining pool actually used for the original stake, not only the");
    ...
    lines.push("    not decode. If rewards stay at zero, the locked address is usually the");
