...
4. Paste the **mining pool address you already use**, Search, then **Use this pool**.  
   Choosing only the staking proxy will not show your rewards.
5. Stake, unstake, or claim from **Actions**. Buttons stay off until a pool is selected and the contract allows the send.
...
On-chain figures can be zero if the selected address is not the pool you actually staked with.
